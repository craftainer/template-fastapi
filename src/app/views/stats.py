...
why): these wrap an already-computed app.repositories.stats.ResourceStats /
app.controllers.crud_stats.Prediction, not a raw ORM instance app.interfaces.
...
what lets app.controllers.crud_router's XML router render each row as its own
...
from app.views.base import IXDTFDatetime
...
class LifecycleStatsView(BaseModel):
    """Record-lifecycle mixin breakdown -- see app.repositories.stats.LifecycleStats."""
