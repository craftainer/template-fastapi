...
Numeric/categorical field classification reuses app.controllers.crud_query.
...
plain bucket_start/float pair) rather than tied to app.repositories.stats.
...
from app.controllers.crud_query import FieldKind, field_specs
from app.repositories.stats import TimeBucket, TimeBucketCount
...
class InsufficientHistoryError(Exception):
    ...
    app.controllers.crud_router's `/predict` route catches this and re-raises it
...
def _bucket_start(bucket: TimeBucket, value: datetime) -> datetime:
    ...
    Mirrors app.repositories.memory's own `_bucket_start` helper.
    """
