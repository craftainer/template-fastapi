...
class TimeBucketCount:
    ...
    stores every other timestamp (see app.models.base.IdentifiedBase).
    """
...
class LifecycleStats:
    """Record-lifecycle mixin breakdown -- see app.models.mixins.

    Each field is None when the bound model doesn't carry the corresponding
    mixin (detected via `hasattr`, the same pattern app.repositories.sqlalchemy/
    app.repositories.memory already use elsewhere) -- a model with no
